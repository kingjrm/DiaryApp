...
<div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="glass rounded-xl p-8 neumorphism">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 font-poppins">Edit Diary Entry</h1>
                <p class="text-sm text-gray-600 mt-1">Customize your memory and make it special</p>
            </div>
            <div class="text-right">
                <p class="text-xs text-gray-500">Created: <?php echo date('M j, Y', strtotime($entry['created_at'])); ?></p>
                <p class="text-xs text-gray-500">Last updated: <?php echo date('M j, Y', strtotime($entry['updated_at'])); ?></p>
            </div>
        </div>
        ...
        <form id="diary-form" action="<?php echo APP_URL; ?>/diary/edit/<?php echo $entry['id']; ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" id="date" name="date" value="<?php echo $entry['entry_date']; ?>" required
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200 neumorphism">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <input type="color" id="background_color" name="background_color"
                                               value="<?php echo htmlspecialchars($entry['background_color'] ?? '#ffffff'); ?>"
                                ...
                                <div class="border-t pt-4">
                                    ...
                                    <?php if (!empty($entry['background_image'])): ?>
                                        <div class="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded-md">
                                            <p class="text-xs text-yellow-700 flex items-center">
                                                ...
                                                Current background image will be replaced if you upload a new one
                                            </p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <input type="color" id="text_color" name="text_color"
                                               value="<?php echo htmlspecialchars($entry['text_color'] ?? '#000000'); ?>"
                                               class="w-12 h-10 border border-gray-300 rounded-md neumorphism-inset cursor-pointer">
                                        <input type="text" readonly
                                               value="<?php echo htmlspecialchars($entry['text_color'] ?? '#000000'); ?>"
                                               class="flex-1 px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-sm font-mono">
                                ...
                                <div class="border-t pt-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-3">
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                            <input type="checkbox" id="text_bold" name="text_bold"
                                                   <?php echo ($entry['text_bold'] ?? 0) ? 'checked' : ''; ?>
                                        ...
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                            <input type="checkbox" id="text_italic" name="text_italic"
                                                   <?php echo ($entry['text_italic'] ?? 0) ? 'checked' : ''; ?>
                                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                        ...
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                            <input type="checkbox" id="text_underline" name="text_underline"
                                                   <?php echo ($entry['text_underline'] ?? 0) ? 'checked' : ''; ?>
                                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
            ...
            <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-6 border border-yellow-100">
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="content" name="content" rows="12" required
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent neumorphism-inset resize-none <?php echo $entry['font_family'] ?? 'font-poppins'; ?>"
                              placeholder="Pour your heart out..."><?php echo htmlspecialchars($entry['content']); ?></textarea>
            ...
            <div class="bg-gradient-to-r from-red-50 to-pink-50 rounded-lg p-6 border border-red-100">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center">
                        <i class="fas fa-images text-red-500 mr-3"></i>
                        <h2 class="text-xl font-semibold text-gray-800">Current Images</h2>
                    </div>
                    <span class="text-sm text-gray-600 bg-white px-3 py-1 rounded-full border"><?php echo count($images); ?> image<?php echo count($images) !== 1 ? 's' : ''; ?></span>
                </div>
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-6 border border-indigo-100">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Add More Images</h2>
