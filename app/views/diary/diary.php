...
<div class="pt-16 pb-8 min-h-screen bg-gradient-to-br from-pink-50/30 via-white to-purple-50/30">
    <div class="md:ml-72">
                    ...
                    <div class="diary-card absolute cursor-pointer group"
                        ...
                        <div class="bg-white rounded-lg shadow-lg border-4 border-white relative overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105 w-64 min-h-[120px]"
                             style="background-color: <?php echo htmlspecialchars($entry['background_color'] ?? '#ffffff'); ?>;
                                    <?php if (!empty($entry['background_image'])): ?>background-image: url('<?php echo htmlspecialchars(assetUrl($entry['background_image'])); ?>'); background-size: cover; background-position: center;<?php endif; ?>">
...
document.addEventListener('mousemove', function(e) {
    ...
    // Prevent moving past left/top (sidebar/header)
...
document.addEventListener('mouseup', function() {
    ...
    let x = parseFloat(draggedElement.style.left);
    let y = parseFloat(draggedElement.style.top);

    // Ensure saved position is not negative
...
function saveCardPosition(entryId, x, y, rotation, zIndex) {
    fetch('<?php echo appBaseUrl(); ?>/index.php?url=/api/update-position', {
        method: 'POST',
        headers: {
...
function viewEntry(id) {
    window.location.href = '<?php echo appBaseUrl(); ?>/index.php?url=/diary/view/' + id;
}

function editEntry(id) {
    window.location.href = '<?php echo appBaseUrl(); ?>/index.php?url=/diary/edit/' + id;
}
...
function deleteEntry(id) {
    if (confirm('Are you sure you want to delete this entry?')) {
        ...
        form.method = 'POST';
        form.action = '<?php echo appBaseUrl(); ?>/index.php?url=/diary/delete/' + id;
